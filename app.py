...
def baixar_dados_coordenada(dataset_id, var, lat, lon, ano):
    username = st.secrets.get("COPERNICUS_USERNAME", "")
    password = st.secrets.get("COPERNICUS_PASSWORD", "")

    if not username or not password:
        st.error("Credenciais do Copernicus não encontradas em st.secrets. Configure COPERNICUS_USERNAME e COPERNICUS_PASSWORD no painel do Streamlit Cloud.")
        return None
